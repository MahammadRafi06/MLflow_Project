...
def mlflow_run(params, run_name="Tracking Experiment: TensorFlow - CNN "):
    with mlflow.start_run(run_name=run_name) as run:  # Corrected 'r_name' to 'run_name'
...
if __name__ == '__main__':
    ...
    convSize = int(sys.argv[1]) if len(sys.argv) > 1 else 3  # Default convSize to 3
    epochs = int(sys.argv[2]) if len(sys.argv) > 2 else 3  # Fixed default epochs value to 3 (instead of (3, 3))
